# Microsoft Store submission — CVAT Tools
...
CVAT Tools giúp đội annotation kiểm tra dữ liệu CVAT nhanh và riêng tư trên Windows.
...
| Trường | Giá trị |
| --- | --- |
| Package/Identity/Name | cvattools.CVATTools |
| Package/Identity/Publisher | CN=63147F28-03C4-435D-B5F4-AAD25100D8FD |
| Package/Properties/PublisherDisplayName | cvattools |
...
```powershell
$env:STORE_IDENTITY_NAME = 'cvattools.CVATTools'
$env:STORE_PUBLISHER = 'CN=63147F28-03C4-435D-B5F4-AAD25100D8FD'
$env:STORE_PUBLISHER_DISPLAY_NAME = 'cvattools'
